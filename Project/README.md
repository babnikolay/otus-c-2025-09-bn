...
- [Как использовать](#как-использовать)
  ...
  - [8. mandelbrot_gtk.c](#8.-mandelbrot_gtk.c)
...
Произойдет сборка всех программ сразу и проверка на наличие необходимых библиотек и автоматическая установка их, если они отсутствуют.  
Возможность собирать только отдельные программы через __Cmake__, как это сделано в __make__-сборке, не предусмотрена.  
...
Тоже, что и предыдущий (файл mandelbrot_degree_%g.ppm), но цветовая палитра сглажена (логарифмический алгоритм 
...
На выходе получается каталог __frames__ с множеством ppm файлов, которы затем можно преобразовать в видео (см. ниже).  
