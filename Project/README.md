...
- [Описание](#описание)
- [Задача](#задача-—-создать-исследовательский-проект-Mandelbrot-Explorer)
...
Возможность собирать только отдельные программы через __Cmake__, как это сделано через __make__-сборку, не предусмотрена.  
