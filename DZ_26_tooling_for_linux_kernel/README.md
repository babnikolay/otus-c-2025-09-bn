...
1. Написать простую программу на С.  
2. Настроить ftrace.  
3. Собрать данные о системных вызовах.  
4. Написать отчёт.  
...
# Цель задания   
Научиться анализировать системные вызовы программы.  

# Критерии успеха  

1. Программа должна содержать не менее 5 различных системных вызовов.  
2. Корректно настроен и использован ftrace.  
3. Представлен подробный анализ результатов.  
4. Код и отчёт должны быть хорошо оформлены.  
...
> Можно использовать эту информацию для дальнейшего анализа и оптимизации программ в системах на базе Linux.  
